...
module.exports = function (webpackEnv) {
    ...
    return {
        ...
        resolve: {
            ...
            alias: {
                // Directories' aliases
                '@theme': path.resolve(paths.appSrc, 'ui/theme.ts'),
                '@links': path.resolve(paths.appSrc, 'ui/links.tsx'),
                '@components': path.resolve(paths.appSrc, 'ui/components'),
                '@containers': path.resolve(paths.appSrc, 'ui/containers'),
                '@screens': path.resolve(paths.appSrc, 'ui/screens'),
                '@utils': path.resolve(paths.appSrc, 'utils'),
                '@db': path.resolve(paths.appSrc, 'db'),
